...
do
    ...
    do
        ...
        # train model
        vw_train="vw --oaa 26 isolet_train.vw --cache_file cache_train --sgd -l $l_rate --passes $n_passes -f oaa.model"
        ...
        # test model
        vw_test="vw -t --cache_file cache_test -i oaa.model isolet_test.vw"
